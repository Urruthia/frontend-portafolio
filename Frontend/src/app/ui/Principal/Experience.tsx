export default function Experience (){
    ...
    return(        <div className="flex flex-col lg:flex-row justify-center items-start mt-20 px-4">
    ...
    <div className="flex flex-col items-start space-y-4">
        ...
        <div className="bg-gray-800 p-4 rounded-lg shadow-lg max-w-md w-full transform transition-all duration-500 hover:scale-105">
            ...
            <p className="text-2xl font-bold  text-gray-300">Soy una persona que intenta buscar el balance entre salud y esfuerzo de trabajo, hago ejericico e intento comer bien</p>
            <p className="text-2xl font-bold  text-gray-300">Soy aficionado de los videojuegos deportes, freestyle y me encata escuchar musica</p>
        </div>
    </div>

    <div className="bg-gray-800 p-6 rounded-lg shadow-lg max-w-2xl w-full ml-4 transform transition-all duration-500 hover:scale-105">
